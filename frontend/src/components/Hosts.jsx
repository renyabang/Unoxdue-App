...
export default function Hosts() {
  return (
    <section
      id="conduttori"
      className="section-anchor bg-[#fbf7f2] py-20 lg:py-28"
    >
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        <Reveal className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-[#6b5d52] text-base sm:text-lg mt-4">
            Tre voci, un'unica passione per il calcio.
          </p>
        </Reveal>

        <div className="grid md:grid-cols-3 gap-7 mt-14">
          {hosts.map((h, i) => (
            <Reveal key={h.id} delay={i * 110}>
              <article className="lift group h-full bg-white rounded-3xl overflow-hidden border border-[#ecdfce] shadow-sm hover:shadow-2xl hover:border-[#EA4E1B]/40 flex flex-col">
                <div className="relative aspect-[4/5] overflow-hidden bg-[#14100e]">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <h3 className="font-anton text-white text-3xl leading-none">
                      {h.nickname}
                    </h3>
